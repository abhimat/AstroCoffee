...
<body>
	...
	<div class="content wrap">
		<section class="blocks">
			<article class="block">
				<h2>Bookmarklet</h2>
				<center><a href="javascript:(function(){location.href='http://coffee.astro.ucla.edu/bookmarker.php?article='+encodeURIComponent(location.href);})();">Add to Astro Coffee</a></center>
